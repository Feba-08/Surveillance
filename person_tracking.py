...
phone_number = "+917736279756" 
message = "Someone Crossed"
...
def main():
    ...
    while True:
        ...
        # area =  [(400, 500),(30, 500), (430, 5),(570, 5)]
        area =  [(500, 500),(10, 500), (430, 5),(570, 5)]
        ...
        for (objectId, bbox) in objects.items():
            ...
            if(result>=0):
               ...
               if(objectId not in person_in_id):
                 ...
                 if(int(dwell_time[objectId])>0 and lock==0):
                    print('Anomaly')
                    lock=1
                    ...
                    kit.sendwhatmsg(phone_number,message,int(hr),int(min)+1)
                    pg.press("enter") 
